...
# ---------------------------------------------------------------------------
$CsvPath = "C:\Migration\NewEmails.csv"
$LogPath = "C:\Migration\PrimaryEmailChange_Log_$(Get-Date -Format 'yyyyMMdd_HHmmss').csv"
$DryRun  = $true   # set to $true to preview changes without applying them, set to $false to run and apply
...
if (-not $existingSession) {
    Write-Host "Connecting to Exchange Online (GCC High)..." -ForegroundColor Cyan
